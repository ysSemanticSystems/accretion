...
| `assets/ships/scout.glb` | Quaternius (via Poly Pizza) | CC0 | https://poly.pizza/ | Alternate ship; not wired in scene |
| `assets/debris/debris_01.glb` | Poly Pizza (rock) | CC0 | https://poly.pizza/ | Harvestable debris variant |
| `assets/debris/debris_02.glb` | Poly Pizza (rock) | CC0 | https://poly.pizza/ | Harvestable debris variant |

Add a row for every external mesh, texture, HDRI, or audio file committed under `assets/`.
